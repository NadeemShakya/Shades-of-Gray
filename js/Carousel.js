...
const IMAGE_COUNT = 4;
const FPS = 60;
const CAROUSEL_CONTAINER_WIDTH = 100; // 49view port width.
const SLIDER_ARROW_WIDTH = SLIDER_ARROW_HEIGHT = 35;
const SLIDER_CONTAINER_WIDTH = 50;
const SLIDER_CONTAINER_HEIGHT = 80;
const DOT_CONTAINER_WIDTH = DOT_CONTAINER_HEIGHT = 10;
...
class Carousel {
  constructor(carouselContainer, carouselImgWrapper, animationTime, holdTime) {
    ...
    this.carouselContainer.style.maxWidth = `${73.125}em`;
    ...
    this.images = this.carouselImgWrapper.querySelectorAll('.carousel-sections');
  ...
  init() {
    ...
    setInterval(() => {
      ...
      for(let i = 0; i < dots.length; i++) {
        dots[i].style.background = "#b6dbf6";
      }
      tempDot.style.background = "#3baafe";
    }, 16.667);
